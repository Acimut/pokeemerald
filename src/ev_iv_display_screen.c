...
const u8 gText_eviv_Power[]  = _("Potencia: ");
...
const u8 gText_eviv_Power[]  = _("Power: ");
...
static EWRAM_DATA struct EvIv *gEvIv = NULL;
...
static void Task_EvIvReturn(u8 taskId)
{
    ...
    {
        EvIv_SummaryScreen_Callback(SS_cursorPos);
    }
    else
    {
        SetMainCallback2(CB2_ReturnToFieldFadeFromBlack);
    }
    TRY_FREE_AND_SET_NULL(gEvIv);
}
...
static void PrintWindow_HiddenPower(u8 isEgg)
{
    ...
    if (!isEgg)
    {
        ...
        StringCopy(gStringVar4, gText_eviv_Power);
        StringAppend(gStringVar4, gStringVar1);
...
static u8 GetColorByNature(u8 nature, u8 stat)
{
    ...
    return gNatureStatTable[nature][stat - 1] + 1;
}


#undef EV_IV_TEXT
#undef HIDDEN_POWER_STATIC
#undef HIDDEN_POWER_BASE_POWER
#undef SPRITE_JUMP
#undef SPRITE_JUMP_DIRECTION
#undef SPRITE_VIEW_DIRECTION
#undef PICMON_X
#undef PICMON_Y

#undef WINDOW0_WIDTH
#undef WINDOW0_HEIGTH
#undef WINDOW1_WIDTH
#undef WINDOW1_HEIGTH
#undef WINDOW1_BASEBLOCK
#undef WINDOW2_WIDTH
#undef WINDOW2_HEIGTH
#undef WINDOW2_BASEBLOCK
#undef WINDOW3_WIDTH
#undef WINDOW3_HEIGTH
#undef WINDOW3_BASEBLOCK
#undef WINDOW4_WIDTH
#undef WINDOW4_HEIGTH
#undef WINDOW4_BASEBLOCK
#undef WINDOW5_WIDTH
#undef WINDOW5_HEIGTH
#undef WINDOW5_BASEBLOCK
